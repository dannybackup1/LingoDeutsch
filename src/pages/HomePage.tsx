        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="w-60 px-8 py-3 bg-white text-primary font-semibold rounded-lg shadow-lg
            ...
            <button
              ...
              className="w-60 px-8 py-3 bg-transparent border-2 border-white text-white font-semibold
